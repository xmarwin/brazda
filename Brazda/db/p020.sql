...
('RAP', 'Nutná horolezecká výbava', null, 'rappelling', 2),
...
('PSF', 'Jedovaté rostliny', 'Žádné jedovaté rostliny v okolí', 'poisonoak', 3),
('DGA', 'Nebezpečná zvířata', null, 'dangerousanimals', 2),
('TCK', 'Klíšťata', null, 'ticks', 2),
('MIN', 'Opuštěné doly', null, 'mine', 2),
...
('WTR', 'Blízký zdroj pitné vody', 'V okolí není pitná voda', 'water', 3),
...
('JEP', 'Přístup teréním autem', 'Nejezdi sem teréním
 autem', 'jeeps', 3),
('SNM', 'Přístup na sněžném skůtru', 'Nejezdi sem na sněžném skůtru', 'snowmobiles', 3),
...
('ABB', 'Opuštěné budovy',  'Není v opuštěném objektu', 'abandonedbuilding', 3),
('HKS', 'Krátka trasa (méně než 1 km)', 'Trasa delší než 1 km',  'hike_short', 3),
('HKM', 'Trasa 1-10 km', 'Toto není středně dlouhá trasa', 'hike_med', 3),
('HKL', 'Dlouhá trasa (více než 10 km)', 'Trasa méně než 10 km', 'hike_long', 3),
...
('TOK', 'Turisticky atraktivní', 'Není ideální pro turisty', 'touristOK', 3),
