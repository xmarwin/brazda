...
"C:\Program Files\PostgreSQL\9.5\bin\createdb.exe" -O brazda_test -E UTF8 -T template0  -U postgres -O brazda
...
"C:\Program Files\PostgreSQL\9.5\bin\psql.exe" -f p012.sql
if errorLevel 1 ( exit /b %errorLevel%; )

ECHO Aplikuji patch 013...
"C:\Program Files\PostgreSQL\9.5\bin\psql.exe" -f p013.sql
if errorLevel 1 ( exit /b %errorLevel%; )

ECHO Aplikuji patch 014...
"C:\Program Files\PostgreSQL\9.5\bin\psql.exe" -f p014.sql
if errorLevel 1 ( exit /b %errorLevel%; )
