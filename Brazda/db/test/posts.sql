...
SELECT setval('teams_team_seq', 1) AS set_teams_team_seq;
...
INSERT INTO posts (post, post_type,color,name,max_score,difficulty,terrain,cache_size,cache_type,shibboleth,with_staff,help,description,bonus_code,hint,latitude,longitude)
     VALUES
            (1, 'BEG', 'TRA', 'Start', 0, 1, 1, 'O', null, 'cvok', True, '', '<p><strong>Vítejte na startu závodu BRAZDA 2016=7</strong>.<br> Přejeme Vám hodně štěstí, výdrže a odhodlání jej dokončit :)</p>', null, null, 49.4671494, 18.1633683),

            (2, 'END', 'TRA', 'Cíl', 0, 1, 1, 'O', null, 'mat', True, '', '<p><strong>Gratulejeme k dokončení závodu BRAZDA 2017</strong>.<br> Těšíme se na Vás u vyhlášení výsledků <strong>ve 20.30</strong>.</p>', null, null, 49.4671494, 18.1633683);

SELECT setval('posts_post_seq', 2) AS set_posts_post_seq;
